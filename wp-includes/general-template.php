...
function feed_links_extra($args = array())
{
	...
	if (isset($title) && isset($href)) {
		echo '<link rel="alternate" type="' . feed_content_type() . '" title="' . esc_attr($title) . '" href="' . $href . '" />' . "\n";
	}
}
...
function rsd_link()
{
	echo '<link rel="EditURI" type="application/rsd+xml" title="RSD" href="' . site_url('xmlrpc.php?rsd', 'rpc') . '" />' . "\n";
}
