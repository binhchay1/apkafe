...
class Frontend {
	...
	public function __construct() {
		if ( $this->get_measurement_id() ) {
			...
			if(htga4()->get_option('add_to_cart_event')){
				add_action( 'woocommerce_add_to_cart', array($this, 'woocommerce_add_to_cart_cb'), 10, 6 ); // works both ajax/non ajax
	...
	public function detect_added_to_cart_after_redirect_in_cart_page(){
		...
		add_action('wp_footer', function() use ($last_added_item){
...
Frontend::instance(); // Initiate the plugin