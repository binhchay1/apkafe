    ...
    <?php if(!$this->is_pro_plugin_active()): ?>
		<div class="">
			<div class="htga4-notice notice-warning"> 
				<p><?php echo __( 'Realtime reports are available in the <a href="https://hasthemes.com/plugins/google-analytics-plugin-for-wordpress?utm_source=wp-org&utm_medium=ht-ga4&utm_campaign=htga4_tab_ecommerce_reports" target="_blank">Pro version</a>.', 'ht-easy-ga4' ); ?></p>
			</div>
		</div>
    <?php
        endif;
