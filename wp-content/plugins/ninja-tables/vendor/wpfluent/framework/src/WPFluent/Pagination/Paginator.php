...
use NinjaTables\Framework\Pagination\Presenter;
use NinjaTables\Framework\Pagination\PaginatorInterface as PaginatorContract;
...
class Paginator extends AbstractPaginator implements ArrayableInterface, ArrayAccess, Countable, IteratorAggregate, JsonSerializable, JsonableInterface, PaginatorContract
{
     ...
     *
     * @param  \NinjaTables\Framework\Pagination\Presenter|null  $presenter
     * @return string
     */
