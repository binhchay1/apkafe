...
<?php foreach ( $this->items as $i => $item ) : ?>
    ...
    <div class="<?php echo $this->get_classes('box'); ?>" <?php $this->the_product_container(); ?>>
        ...
        <div class="aawp-box__content">
            <a class="aawp-box__title" href="<?php echo $this->get_product_url(); ?>" title="<?php echo $this->get_product_link_title(); ?>" rel="nofollow noopener sponsored" target="_blank"><?php echo $this->get_product_title(); ?></a>
