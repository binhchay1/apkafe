	...
	<div class="row align-items-center">
		...
		<div class="col-lg-4 font-weight-bold text-lg-left text-center pb-lg-0 pb-1">
			...
			<ul class="row-edit-hover">
				...
				<li><a href="${ element.link_slug_original }" target="_blank" class="light-purple hover-purple-text small cursor-pointer"><i class="far fa-external-link-alt"></i> Open in New Window</a></a>
			</ul>
		</div>
		...
		<div class="col-lg-4 text-lg-left text-center pb-lg-0 pb-1">
			...
			<ul class="row-edit-hover">
				...
				<li><a href="${ element.permalink }" class="light-purple hover-purple-text small cursor-pointer" target="_blank"><i class="far fa-external-link-alt"></i> Open in New Window</a></li>
			</ul>
		</div>

		<!-- MONETIZE SUGGESTION -->
		<div class="col-lg-2 text-lg-left text-center pb-lg-0 pb-1">
			<a href="edit.php?post_type=lasso-urls&page=url-details&post_id=${ element.lasso_id }" target="_blank" class="black hover-purple-text">
				${ element.lasso_suggestion }
			</a>
			<?php if ( ! isset( $_GET['post_id'] ) ) { ?>
			<ul class="row-edit-hover">
				<li><a href="edit.php?post_type=lasso-urls&page=link-opportunities&post_id=${ element.lasso_id }" class="light-purple hover-purple-text small cursor-pointer"><i class="far fa-filter"></i> Filter by Link</a></li>
			</ul>
			<?php } ?>
		</div>
