						...
						<div class="row">
							...
							<div class="col-lg-4">
								<div class="form-group mb-4">
									...
									<input type="text" class="form-control" id="buy_btn_text" value="<?php echo esc_html( $lasso_url->display->primary_button_text ); ?>"
										placeholder="<?php echo esc_html( $lasso_url->display->primary_button_text_default ); ?>">
								</div>
							</div>
						...
						<div class="row">
							<div class="col-lg-8">
								<div class="form-group mb-4">
									...
									<input type="text" class="form-control" id="second_btn_url" value="<?php echo esc_html( $lasso_url->display->secondary_url ); ?>"
										placeholder="https://www.example.com/affiliate-id2">
								</div>
							</div>
...
<script>
	jQuery(document).ready(function() {
		...
		function setProgressComplete() {
			...
			jQuery("#url-save").find(".progress-bar").css({width: progessPercentage + '%'});
		}
