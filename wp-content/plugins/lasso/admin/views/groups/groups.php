	...
	<!-- TITLE BAR -->
		...
		<!-- TITLE -->
			<div class="col-lg text-lg-left text-center mb-4">
				...
				<a href="edit.php?post_type=lasso-urls&page=group-details" class="btn ml-1 btn-sm">
					<i class="far fa-plus-circle"></i> Add New Group
				</a>
			</div>
			...
			<div class="col-lg-4 mb-4">
				<form role="search" method="get" id="links-filter" autocomplete="off">
					<div id="search-links">
						<input type="search" id="link-search-input" name="link-search-input" class="form-control" placeholder="Search Groups">
					</div>
				</form>
			</div>
		</div>
		...
		<!-- TABLE HEADER -->
			<div class="px-4 pt-4 pb-2 font-weight-bold dark-gray d-lg-block">
				<div class="row align-items-center">
					...
					<div class="col-lg-1 text-center">Links</div>
				</div>
			</div>
