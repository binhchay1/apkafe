		...
		<div class="lasso-box-3">
			...
			<div class="lasso-date">
				...
				if ( $lasso_url->display->show_date && $lasso_url->display->show_price && '' !== $lasso_url->price ) {
					// phpcs:ignore
					echo $lasso_url->display->last_updated . ' <i class="lasso-amazon-info" 
						data-tooltip="Price and availability are accurate as of the date and time indicated and are subject to change."></i>';
				}
				?>
			</div>
		</div>
