...
$show_disclosure_setting = $grid_disclosure;
$disclosure_text_setting = Setting::lasso_get_setting( 'disclosure_text' );
...
if ( $show_disclosure_setting && $disclosure_text_setting ) {
	print '<div class="lasso-disclosure">' . $disclosure_text_setting . '</div>';
}
print '</div>';
