...
<div id="group-monetize" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		...
		<div class="modal-content p-0 shadow">
			...
			<div class="row px-5 pt-5">
				...
				<div class="col-lg mb-4">
					<input type="text" class="form-control js-monetize-search" placeholder="Search 328 Groups">
				</div>
			</div>
