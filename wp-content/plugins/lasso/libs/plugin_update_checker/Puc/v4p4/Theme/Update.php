...
if ( !class_exists('Lasso_Puc_v4p4_Theme_Update', false) ):

	class Lasso_Puc_v4p4_Theme_Update extends Lasso_Puc_v4p4_Update {
		public $details_url = '';
		 ...
		 *
		 * @param StdClass|Lasso_Puc_v4p4_Theme_Update $object The source object.
		 * @return Lasso_Puc_v4p4_Theme_Update The new copy.
		 */
