<?php
if ( !class_exists('Lasso_Puc_v4p4_Vcs_PluginUpdateChecker') ):

	class Lasso_Puc_v4p4_Vcs_PluginUpdateChecker extends Lasso_Puc_v4p4_Plugin_UpdateChecker implements Lasso_Puc_v4p4_Vcs_BaseChecker {
		/**
		...
		/**
		 * Lasso_Puc_v4p4_Vcs_PluginUpdateChecker constructor.
		 *
		...
		public function requestInfo($unusedParameter = null) {
			...
			$info = new Lasso_Puc_v4p4_Plugin_Info();
		 ...
		 * @param Lasso_Puc_v4p4_Plugin_Info $pluginInfo
		 */
