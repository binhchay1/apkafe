<?php
if ( !class_exists('Lasso_Puc_v4p4_Vcs_Api') ):

	abstract class Lasso_Puc_v4p4_Vcs_Api {
		...
		/**
		 * Lasso_Puc_v4p4_Vcs_Api constructor.
		 *
		...
		public function getRemoteReadme($ref = 'master') {
			...
			$parser = new LassoPucReadmeParser();
		...
		public function getRemoteChangelog($ref, $localDirectory) {
			...
			return LassoParsedown::instance()->text($changelog);
		}
