<?php
if ( !class_exists('Lasso_Puc_v4p4_Vcs_BitBucketApi', false) ):

	class Lasso_Puc_v4p4_Vcs_BitBucketApi extends Lasso_Puc_v4p4_Vcs_Api {
		/**
		 * @var Lasso_Puc_v4p4_OAuthSignature
		 */
		private $oauth = null;
		...
		public function setAuthentication($credentials) {
			...
			if ( !empty($credentials) && !empty($credentials['consumer_key']) ) {
				$this->oauth = new Lasso_Puc_v4p4_OAuthSignature(
