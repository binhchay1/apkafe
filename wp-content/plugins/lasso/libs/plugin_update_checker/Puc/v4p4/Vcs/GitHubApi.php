...
if ( !class_exists('Lasso_Puc_v4p4_Vcs_GitHubApi', false) ):

	class Lasso_Puc_v4p4_Vcs_GitHubApi extends Lasso_Puc_v4p4_Vcs_Api {
		/**
		 ...
		 *
		 * @return Lasso_Puc_v4p4_Vcs_Reference|null
		 */
		public function getLatestRelease() {
			...
			$reference = new Lasso_Puc_v4p4_Vcs_Reference(array(
			...
			if ( !empty($release->body) ) {
				...
				$reference->changelog = LassoParsedown::instance()->text($release->body);
			}
		...
		public function getLatestTag() {
			...
			$tag = $versionTags[0];
			return new Lasso_Puc_v4p4_Vcs_Reference(array(
				'name'        => $tag->name,
		 ...
		 * @return null|Lasso_Puc_v4p4_Vcs_Reference
		 */
