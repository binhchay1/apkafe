...
if ( !class_exists('Lasso_Puc_v4p4_Vcs_ThemeUpdateChecker', false) ):

	class Lasso_Puc_v4p4_Vcs_ThemeUpdateChecker extends Lasso_Puc_v4p4_Theme_UpdateChecker implements Lasso_Puc_v4p4_Vcs_BaseChecker {
		/**
		...
		/**
		 * @var Lasso_Puc_v4p4_Vcs_Api Repository API client.
		 */
		protected $api = null;

		/**
		 * Lasso_Puc_v4p4_Vcs_ThemeUpdateChecker constructor.
		 *
		 * @param Lasso_Puc_v4p4_Vcs_Api $api
		...
		public function requestUpdate() {
			...
			$update = new Lasso_Puc_v4p4_Theme_Update();
			...
			$update->version = Lasso_Puc_v4p4_Utils::findNotEmpty(array(
				$remoteHeader['Version'],
				Lasso_Puc_v4p4_Utils::get($updateSource, 'version'),
			));

			//The details URL defaults to the Theme URI header or the repository URL.
			$update->details_url = Lasso_Puc_v4p4_Utils::findNotEmpty(array(
