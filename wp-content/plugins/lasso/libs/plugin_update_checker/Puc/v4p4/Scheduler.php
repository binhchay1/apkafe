<?php
if ( !class_exists('Lasso_Puc_v4p4_Scheduler', false) ):

	/**
	 * The scheduler decides when and how often to check for updates.
	 * It calls @see Lasso_Puc_v4p4_UpdateChecker::checkForUpdates() to perform the actual checks.
	 */
	class Lasso_Puc_v4p4_Scheduler {
		 ...
		 *
		 * @param Lasso_Puc_v4p4_UpdateChecker $updateChecker
