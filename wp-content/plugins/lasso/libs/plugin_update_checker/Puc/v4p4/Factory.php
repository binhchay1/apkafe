<?php
if ( !class_exists('Lasso_Puc_v4p4_Factory', false) ):
	...
	class Lasso_Puc_v4p4_Factory {
		 ...
		 *
		 * @see Lasso_Puc_v4p4_UpdateChecker::__construct
		 *
		 ...
		 * @return Lasso_Puc_v4p4_Plugin_UpdateChecker|Lasso_Puc_v4p4_Theme_UpdateChecker|Lasso_Puc_v4p4_Vcs_BaseChecker
		 */
		...
		public static function addVersion($generalClass, $versionedClass, $version) {
			if ( empty(self::$myMajorVersion) ) {
				...
				self::$myMajorVersion = substr(ltrim($nameParts[2], 'v'), 0, 1);
			}
