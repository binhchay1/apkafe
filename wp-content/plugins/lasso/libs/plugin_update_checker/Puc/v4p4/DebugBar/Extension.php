<?php
if ( !class_exists('Lasso_Puc_v4p4_DebugBar_Extension', false) ):

	class Lasso_Puc_v4p4_DebugBar_Extension {
		const RESPONSE_BODY_LENGTH_LIMIT = 4000;

		/** @var Lasso_Puc_v4p4_UpdateChecker */
		protected $updateChecker;
		protected $panelClass = 'Lasso_Puc_v4p4_DebugBar_Panel';
		...
		private function getLibraryUrl($filePath) {
			...
			$absolutePath = Lasso_Puc_v4p4_Factory::normalizePath($absolutePath);

			$pluginDir = Lasso_Puc_v4p4_Factory::normalizePath(WP_PLUGIN_DIR);
			$muPluginDir = Lasso_Puc_v4p4_Factory::normalizePath(WPMU_PLUGIN_DIR);
			$themeDir = Lasso_Puc_v4p4_Factory::normalizePath(get_theme_root());
