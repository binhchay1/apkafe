<?php
if ( !class_exists('Lasso_Puc_v4p4_Plugin_Update', false) ):
	 ...
	 * @access public
	 */
	class Lasso_Puc_v4p4_Plugin_Update extends Lasso_Puc_v4p4_Update {
		public $id = 0;
		public $homepage;
		...
		public static function fromJson($json){
			...
			$pluginInfo = Lasso_Puc_v4p4_Plugin_Info::fromJson($json);
			if ( $pluginInfo !== null ) {
		 ...
		 *
		 * @param Lasso_Puc_v4p4_Plugin_Info $info
		 * @return Lasso_Puc_v4p4_Plugin_Update
		 */
		 ...
		 *
		 * @param StdClass|Lasso_Puc_v4p4_Plugin_Info|Lasso_Puc_v4p4_Plugin_Update $object The source object.
		 * @return Lasso_Puc_v4p4_Plugin_Update The new copy.
		 */
