...
namespace LassoVendor\Http\Message\StreamFactory;

use LassoVendor\Http\Message\StreamFactory;
use LassoVendor\Laminas\Diactoros\Stream as LaminasStream;
use LassoVendor\Psr\Http\Message\StreamInterface;
use LassoVendor\Zend\Diactoros\Stream as ZendStream;
