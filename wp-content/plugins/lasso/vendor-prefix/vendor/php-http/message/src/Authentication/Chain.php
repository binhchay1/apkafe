...
namespace LassoVendor\Http\Message\Authentication;
    ...
    public function __construct(array $authenticationChain = [])
    {
        foreach ($authenticationChain as $authentication) {
            if (!$authentication instanceof Authentication) {
                throw new \InvalidArgumentException('LassoVendor\\Members of the authentication chain must be of type Http\\Message\\Authentication');
            }
        }
