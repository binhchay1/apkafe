...
use LassoVendor\Http\Client\Common\Exception\CircularRedirectionException;
use LassoVendor\Http\Client\Common\Exception\MultipleRedirectionException;
...
use LassoVendor\Symfony\Component\OptionsResolver\Options;
