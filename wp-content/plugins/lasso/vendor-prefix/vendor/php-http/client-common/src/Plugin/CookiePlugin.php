...
use LassoVendor\Http\Message\Cookie;
use LassoVendor\Http\Message\CookieJar;
use LassoVendor\Http\Message\CookieUtil;
use LassoVendor\Http\Message\Exception\UnexpectedValueException;
