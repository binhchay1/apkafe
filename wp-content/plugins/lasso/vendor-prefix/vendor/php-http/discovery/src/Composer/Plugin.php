...
namespace LassoVendor\Http\Discovery\Composer;

use LassoVendor\Composer\Composer;
use LassoVendor\Composer\DependencyResolver\Pool;
use LassoVendor\Composer\EventDispatcher\EventSubscriberInterface;
use LassoVendor\Composer\Factory;
use LassoVendor\Composer\Installer;
use LassoVendor\Composer\IO\IOInterface;
use LassoVendor\Composer\Json\JsonFile;
use LassoVendor\Composer\Json\JsonManipulator;
use LassoVendor\Composer\Package\Locker;
use LassoVendor\Composer\Package\Version\VersionParser;
use LassoVendor\Composer\Package\Version\VersionSelector;
use LassoVendor\Composer\Plugin\PluginInterface;
use LassoVendor\Composer\Repository\InstalledRepositoryInterface;
use LassoVendor\Composer\Repository\RepositorySet;
use LassoVendor\Composer\Script\Event;
use LassoVendor\Composer\Script\ScriptEvents;
use LassoVendor\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['LassoVendor\\Http\\Client\\HttpAsyncClient'], 'php-http/client-implementation' => ['LassoVendor\\Http\\Client\\HttpClient'], 'psr/http-client-implementation' => ['LassoVendor\\Psr\\Http\\Client\\ClientInterface'], 'psr/http-factory-implementation' => ['LassoVendor\\Psr\\Http\\Message\\RequestFactoryInterface', 'LassoVendor\\Psr\\Http\\Message\\ResponseFactoryInterface', 'LassoVendor\\Psr\\Http\\Message\\ServerRequestFactoryInterface', 'LassoVendor\\Psr\\Http\\Message\\StreamFactoryInterface', 'LassoVendor\\Psr\\Http\\Message\\UploadedFileFactoryInterface', 'LassoVendor\\Psr\\Http\\Message\\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions) : array
    {
        ...
        if (ClassDiscovery::safeClassExists(\LassoVendor\Phalcon\Http\Message\RequestFactory::class, \false)) {
