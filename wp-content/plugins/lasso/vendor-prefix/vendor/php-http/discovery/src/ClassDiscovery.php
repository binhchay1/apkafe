...
use LassoVendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use LassoVendor\Http\Discovery\Exception\DiscoveryFailedException;
use LassoVendor\Http\Discovery\Exception\NoCandidateFoundException;
use LassoVendor\Http\Discovery\Exception\StrategyUnavailableException;
use LassoVendor\Http\Discovery\Strategy\DiscoveryStrategy;
/**
