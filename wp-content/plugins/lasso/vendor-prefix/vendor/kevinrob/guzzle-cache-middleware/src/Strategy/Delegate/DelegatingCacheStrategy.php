...
use LassoVendor\Kevinrob\GuzzleCache\Strategy\NullCacheStrategy;
...
class DelegatingCacheStrategy implements CacheStrategyInterface
{
     ...
     */
    public final function registerRequestMatcher(RequestMatcherInterface $requestMatcher, CacheStrategyInterface $cacheStrategy)
    {
