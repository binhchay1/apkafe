...
namespace LassoVendor\Jean85;

use LassoVendor\Composer\InstalledVersions;
use LassoVendor\Jean85\Exception\ProvidedPackageException;
use LassoVendor\Jean85\Exception\ReplacedPackageException;
use LassoVendor\Jean85\Exception\VersionMissingExceptionInterface;
