...
namespace LassoVendor\Bamarni\Composer\Bin\Command;

use LassoVendor\Bamarni\Composer\Bin\Config\Config;
use LassoVendor\Bamarni\Composer\Bin\Config\ConfigFactory;
use LassoVendor\Bamarni\Composer\Bin\ApplicationFactory\FreshInstanceApplicationFactory;
use LassoVendor\Bamarni\Composer\Bin\Input\BinInputFactory;
use LassoVendor\Bamarni\Composer\Bin\Logger;
use LassoVendor\Bamarni\Composer\Bin\ApplicationFactory\NamespaceApplicationFactory;
use LassoVendor\Composer\Command\BaseCommand;
use LassoVendor\Composer\Factory;
use LassoVendor\Composer\IO\IOInterface;
use LassoVendor\Composer\IO\NullIO;
use LassoVendor\Symfony\Component\Console\Application;
use LassoVendor\Symfony\Component\Console\Input\InputArgument;
