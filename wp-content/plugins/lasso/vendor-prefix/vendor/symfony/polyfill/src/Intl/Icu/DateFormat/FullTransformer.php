 ...
 */
namespace LassoVendor\Symfony\Polyfill\Intl\Icu\DateFormat;

use LassoVendor\Symfony\Polyfill\Intl\Icu\Exception\NotImplementedException;
use LassoVendor\Symfony\Polyfill\Intl\Icu\Icu;
/**
...
class FullTransformer
{
    ...
    public function __construct(string $pattern, string $timezone)
    {
        ...
        $this->transformers = ['M' => new MonthTransformer(), 'L' => new MonthTransformer(), 'y' => new YearTransformer(), 'd' => new DayTransformer(), 'q' => new QuarterTransformer(), 'Q' => new QuarterTransformer(), 'h' => new Hour1201Transformer(), 'D' => new DayOfYearTransformer(), 'E' => new DayOfWeekTransformer(), 'a' => new AmPmTransformer(), 'H' => new Hour2400Transformer(), 'K' => new Hour1200Transformer(), 'k' => new Hour2401Transformer(), 'm' => new MinuteTransformer(), 's' => new SecondTransformer(), 'z' => new TimezoneTransformer()];
    }
    /**
