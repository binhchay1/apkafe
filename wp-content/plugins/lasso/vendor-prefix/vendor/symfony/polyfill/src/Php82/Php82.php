 ...
 */
namespace LassoVendor\Symfony\Polyfill\Php82;
...
class Php82
{
    ...
    public static function ini_parse_quantity(string $value) : int
    {
        ...
        if (16 === $base && $digits_end + 2 < $str_end && '0x' === \substr($value, $digits_end, 2) && \false !== \strpos($allowed_digits, $value[$digits_end + 2])) {
            $digits_end += 2;
        }
