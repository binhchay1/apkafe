 ...
 */
namespace LassoVendor\Symfony\Polyfill\Php82\Random\Engine;

use Random\RandomException;
use LassoVendor\Symfony\Polyfill\Php82\NoDynamicProperties;
/**
...
class Secure
{
    ...
    {
        throw new \Error('LassoVendor\\Trying to clone an uncloneable object of class Random\\Engine\\Secure');
    }
}
