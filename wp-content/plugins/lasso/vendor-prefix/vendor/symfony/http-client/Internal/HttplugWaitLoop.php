...
use LassoVendor\Psr\Http\Message\RequestInterface as Psr7RequestInterface;
...
use LassoVendor\Symfony\Component\HttpClient\Response\StreamableInterface;
use LassoVendor\Symfony\Component\HttpClient\Response\StreamWrapper;
...
final class HttplugWaitLoop
{
    ...
    public function wait(?ResponseInterface $pendingResponse, float $maxDuration = null, float $idleTimeout = null) : int
    {
        ...
        $guzzleQueue = \LassoVendor\GuzzleHttp\Promise\Utils::queue();
