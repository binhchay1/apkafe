 ...
 */
namespace LassoVendor\Symfony\Component\HttpClient\Internal;

use LassoVendor\Amp\CancellationToken;
use LassoVendor\Amp\Deferred;
use LassoVendor\Amp\Http\Client\Connection\ConnectionLimitingPool;
use LassoVendor\Amp\Http\Client\Connection\DefaultConnectionFactory;
use LassoVendor\Amp\Http\Client\InterceptedHttpClient;
use LassoVendor\Amp\Http\Client\Interceptor\RetryRequests;
use LassoVendor\Amp\Http\Client\PooledHttpClient;
use LassoVendor\Amp\Http\Client\Request;
use LassoVendor\Amp\Http\Client\Response;
use LassoVendor\Amp\Http\Tunnel\Http1TunnelConnector;
use LassoVendor\Amp\Http\Tunnel\Https1TunnelConnector;
use LassoVendor\Amp\Promise;
use LassoVendor\Amp\Socket\Certificate;
use LassoVendor\Amp\Socket\ClientTlsContext;
use LassoVendor\Amp\Socket\ConnectContext;
use LassoVendor\Amp\Socket\Connector;
use LassoVendor\Amp\Socket\DnsConnector;
use LassoVendor\Amp\Socket\SocketAddress;
