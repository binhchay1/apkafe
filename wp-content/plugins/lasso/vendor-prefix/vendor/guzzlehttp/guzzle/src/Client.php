...
use LassoVendor\GuzzleHttp\Cookie\CookieJar;
use LassoVendor\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \LassoVendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
