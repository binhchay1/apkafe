...
use LassoVendor\GuzzleHttp\Exception\InvalidArgumentException;
use LassoVendor\GuzzleHttp\Handler\CurlHandler;
use LassoVendor\GuzzleHttp\Handler\CurlMultiHandler;
use LassoVendor\GuzzleHttp\Handler\Proxy;
use LassoVendor\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \LassoVendor\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
