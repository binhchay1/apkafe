...
class EvaluationReason implements \JsonSerializable
{
    ...
    private function __construct(string $kind, ?string $errorKind = null, ?int $ruleIndex = null, ?string $ruleId = null, ?string $prerequisiteKey = null, bool $inExperiment = \false)
    {
        $this->_kind = $kind;
