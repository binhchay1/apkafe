...
class Rule extends VariationOrRollout
{
    ...
    protected function __construct(?int $variation, ?Rollout $rollout, ?string $id, array $clauses, bool $trackEvents)
    {
    ...
    public static function getDecoder() : \Closure
    {
        return function (array $v) {
            return new Rule($v['variation'] ?? null, isset($v['rollout']) ? \call_user_func(Rollout::getDecoder(), $v['rollout']) : null, $v['id'] ?? null, \array_map(Clause::getDecoder(), $v['clauses']), $v['trackEvents'] ?? \false);
        };
    }
