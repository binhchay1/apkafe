...
class LDUser
{
     ...
     * @return LDUser
     */
    public function __construct(string $key, ?string $secondary = null, ?string $ip = null, ?string $country = null, ?string $email = null, ?string $name = null, ?string $avatar = null, ?string $firstName = null, ?string $lastName = null, ?bool $anonymous = null, ?array $custom = [], ?array $privateAttributeNames = [])
    {
        $this->_key = $key;
