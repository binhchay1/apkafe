...
class FlagRuleBuilder
{
    ...
    {
        $newClause = ["attribute" => $attribute, "op" => 'in', "values" => $values, "negate" => \false];
    ...
    {
        $newClause = ["attribute" => $attribute, "op" => 'in', "values" => $values, "negate" => \true];
        $this->_clauses[] = $newClause;
        return $this;
    }
    /**
    ...
    {
        return ["id" => "rule{$id}", "variation" => $this->_variation, "clauses" => $this->_clauses];
    }
}
