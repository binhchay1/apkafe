...
use LassoVendor\Monolog\Formatter\LineFormatter;
use LassoVendor\Monolog\Formatter\FormatterInterface;
use LassoVendor\Monolog\Logger;
use LassoVendor\Monolog\Utils;
use LassoVendor\PhpConsole\Connector;
use LassoVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use LassoVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('LassoVendor\\PhpConsole\\Connector')) {
