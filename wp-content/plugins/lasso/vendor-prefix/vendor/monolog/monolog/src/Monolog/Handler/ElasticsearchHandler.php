...
use LassoVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use LassoVendor\Monolog\Logger;
use LassoVendor\Monolog\Formatter\FormatterInterface;
use LassoVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use LassoVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use LassoVendor\Elasticsearch\Client;
use LassoVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use LassoVendor\Elastic\Elasticsearch\Client as Client8;
/**
