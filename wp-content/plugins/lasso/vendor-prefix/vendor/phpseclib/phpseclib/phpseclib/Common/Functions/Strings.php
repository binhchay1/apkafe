 ...
 */
namespace LassoVendor\phpseclib3\Common\Functions;

use LassoVendor\ParagonIE\ConstantTime\Base64;
use LassoVendor\ParagonIE\ConstantTime\Base64UrlSafe;
use LassoVendor\ParagonIE\ConstantTime\Hex;
use LassoVendor\phpseclib3\Math\BigInteger;
use LassoVendor\phpseclib3\Math\Common\FiniteField;
/**
 * Common String Functions
 *
 * @author  Jim Wigginton <terrafrost@php.net>
