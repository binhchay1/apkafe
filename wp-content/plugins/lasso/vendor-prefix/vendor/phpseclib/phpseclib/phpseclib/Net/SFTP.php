...
use LassoVendor\phpseclib3\Exception\FileNotFoundException;
/**
...
class SFTP extends SSH2
{
    ...
    public function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        if (!\defined('LassoVendor\\NET_SFTP_QUEUE_SIZE')) {
            \define('LassoVendor\\NET_SFTP_QUEUE_SIZE', 32);
        }
        if (!\defined('LassoVendor\\NET_SFTP_UPLOAD_QUEUE_SIZE')) {
            \define('LassoVendor\\NET_SFTP_UPLOAD_QUEUE_SIZE', 1024);
        }
    }
    /**
    ...
    private function send_sftp_packet($type, $data, $request_id = 1)
    {
        ...
        $stop = \microtime(\true);
        if (\defined('LassoVendor\\NET_SFTP_LOGGING')) {
