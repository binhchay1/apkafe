 ...
 */
namespace LassoVendor\phpseclib3\Crypt\EC\Formats\Keys;

use LassoVendor\phpseclib3\Crypt\Common\Formats\Keys\PKCS8 as Progenitor;
use LassoVendor\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
abstract class PKCS8 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (!$params) {
            throw new \RuntimeException('LassoVendor\\Unable to decode the parameters using Maps\\ECParameters');
        }
        $components = [];
