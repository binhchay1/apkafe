 ...
 */
namespace LassoVendor\phpseclib3\Net;

use LassoVendor\phpseclib3\Common\Functions\Strings;
use LassoVendor\phpseclib3\Crypt\Blowfish;
use LassoVendor\phpseclib3\Crypt\ChaCha20;
use LassoVendor\phpseclib3\Crypt\Common\AsymmetricKey;
use LassoVendor\phpseclib3\Crypt\Common\PrivateKey;
use LassoVendor\phpseclib3\Crypt\Common\PublicKey;
use LassoVendor\phpseclib3\Crypt\Common\SymmetricKey;
use LassoVendor\phpseclib3\Crypt\DH;
...
use LassoVendor\phpseclib3\Crypt\RC4;
use LassoVendor\phpseclib3\Crypt\Rijndael;
use LassoVendor\phpseclib3\Crypt\RSA;
use LassoVendor\phpseclib3\Crypt\TripleDES;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use LassoVendor\phpseclib3\Crypt\Twofish;
use LassoVendor\phpseclib3\Exception\ConnectionClosedException;
use LassoVendor\phpseclib3\Exception\InsufficientSetupException;
use LassoVendor\phpseclib3\Exception\NoSupportedAlgorithmsException;
use LassoVendor\phpseclib3\Exception\UnableToConnectException;
use LassoVendor\phpseclib3\Exception\UnsupportedAlgorithmException;
use LassoVendor\phpseclib3\Exception\UnsupportedCurveException;
use LassoVendor\phpseclib3\Math\BigInteger;
use LassoVendor\phpseclib3\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
class SSH2
{
    ...
    private function connect()
    {
        ...
        $extra = $matches[1];
        if (\defined('LassoVendor\\NET_SSH2_LOGGING')) {
    ...
    {
        if (\defined('LassoVendor\\NET_SSH2_LOGGING') && NET_SSH2_LOGGING == self::LOG_COMPLEX) {
