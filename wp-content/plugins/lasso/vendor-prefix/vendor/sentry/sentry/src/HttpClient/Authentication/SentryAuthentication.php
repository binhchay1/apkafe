...
namespace LassoVendor\Sentry\HttpClient\Authentication;

use LassoVendor\Http\Message\Authentication as AuthenticationInterface;
use LassoVendor\Psr\Http\Message\RequestInterface;
use LassoVendor\Sentry\Client;
