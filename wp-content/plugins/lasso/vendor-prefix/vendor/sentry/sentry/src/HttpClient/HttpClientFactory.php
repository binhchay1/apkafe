...
use LassoVendor\GuzzleHttp\RequestOptions as GuzzleHttpClientOptions;
use LassoVendor\Http\Adapter\Guzzle6\Client as Guzzle6HttpClient;
use LassoVendor\Http\Adapter\Guzzle7\Client as Guzzle7HttpClient;
use LassoVendor\Http\Client\Common\Plugin\AuthenticationPlugin;
use LassoVendor\Http\Client\Common\Plugin\DecoderPlugin;
use LassoVendor\Http\Client\Common\Plugin\ErrorPlugin;
use LassoVendor\Http\Client\Common\Plugin\HeaderSetPlugin;
use LassoVendor\Http\Client\Common\Plugin\RetryPlugin;
use LassoVendor\Http\Client\Common\PluginClient;
use LassoVendor\Http\Client\Curl\Client as CurlHttpClient;
use LassoVendor\Http\Client\HttpAsyncClient as HttpAsyncClientInterface;
use LassoVendor\Http\Discovery\HttpAsyncClientDiscovery;
...
use LassoVendor\Sentry\HttpClient\Authentication\SentryAuthentication;
use LassoVendor\Sentry\HttpClient\Plugin\GzipEncoderPlugin;
use LassoVendor\Sentry\Options;
use LassoVendor\Symfony\Component\HttpClient\HttpClient as SymfonyHttpClient;
use LassoVendor\Symfony\Component\HttpClient\HttplugClient as SymfonyHttplugClient;
/**
