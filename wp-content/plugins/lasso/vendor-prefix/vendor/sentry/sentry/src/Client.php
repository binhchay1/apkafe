...
namespace LassoVendor\Sentry;

use LassoVendor\GuzzleHttp\Promise\PromiseInterface;
use LassoVendor\Psr\Log\LoggerInterface;
use LassoVendor\Psr\Log\NullLogger;
use LassoVendor\Sentry\Integration\IntegrationInterface;
use LassoVendor\Sentry\Integration\IntegrationRegistry;
use LassoVendor\Sentry\Serializer\RepresentationSerializer;
use LassoVendor\Sentry\Serializer\RepresentationSerializerInterface;
use LassoVendor\Sentry\Serializer\SerializerInterface;
use LassoVendor\Sentry\State\Scope;
use LassoVendor\Sentry\Transport\TransportInterface;
/**
