...
namespace LassoVendor\Sentry\Tracing;

use Closure;
use LassoVendor\GuzzleHttp\Exception\RequestException as GuzzleRequestException;
...
use function LassoVendor\Sentry\getBaggage;
use function LassoVendor\Sentry\getTraceparent;
/**
