...
namespace LassoVendor\Sentry\Serializer;

use LassoVendor\Sentry\Breadcrumb;
use LassoVendor\Sentry\Event;
use LassoVendor\Sentry\EventType;
use LassoVendor\Sentry\ExceptionDataBag;
use LassoVendor\Sentry\Frame;
use LassoVendor\Sentry\Options;
use LassoVendor\Sentry\Profiling\Profile;
use LassoVendor\Sentry\Tracing\DynamicSamplingContext;
use LassoVendor\Sentry\Tracing\Span;
use LassoVendor\Sentry\Tracing\TransactionMetadata;
use LassoVendor\Sentry\Util\JSON;
/**
