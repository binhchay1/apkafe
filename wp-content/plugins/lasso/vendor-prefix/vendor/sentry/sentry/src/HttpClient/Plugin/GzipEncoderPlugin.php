...
namespace LassoVendor\Sentry\HttpClient\Plugin;

use LassoVendor\Http\Client\Common\Plugin as PluginInterface;
use LassoVendor\Http\Promise\Promise as PromiseInterface;
