...
namespace LassoVendor\Sentry\Monolog;

use LassoVendor\Monolog\Handler\AbstractProcessingHandler;
use LassoVendor\Monolog\Level;
use LassoVendor\Monolog\Logger;
use LassoVendor\Monolog\LogRecord;
