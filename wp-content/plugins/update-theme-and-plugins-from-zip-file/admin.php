...
final class JDS_UTPZIP_Admin {
	...
	public static function update_theme() {
		...
		$upgrader = new JDS_UTPZIP_Theme_Upgrader( new Theme_Installer_Skin( compact( 'type', 'title', 'nonce', 'url' ) ) );
	...
	public static function update_plugin() {
		...
		$upgrader = new JDS_UTPZIP_Plugin_Upgrader( new Plugin_Installer_Skin( compact( 'type', 'title', 'nonce', 'url' ) ) );
		$result = $upgrader->install( $file_upload->package );
