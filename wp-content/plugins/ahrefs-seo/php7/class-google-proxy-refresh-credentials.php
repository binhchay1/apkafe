	...
	public function __construct( $scope, $jsonKey ) {
		...
		$this->auth = new \ahrefs\AhrefsSeo_Vendor\Google\Auth\OAuth2(
			[
				...
				'scope'              => $scope,
				'tokenCredentialUri' => Google_Proxy_Client::OAUTH2_TOKEN_URI, // use it instead of native self::TOKEN_CREDENTIAL_URI.
			]
		);
	}
	// phpcs:enable WordPress.NamingConventions.ValidVariableName.VariableNotSnakeCase -- this is a copy of existing class.
