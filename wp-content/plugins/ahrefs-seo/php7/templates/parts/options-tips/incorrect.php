...
<div class="ahrefs-content-tip tip-notice">
	...
	<div class="text">
		<?php Ahrefs_Seo::get()->get_view()->learn_more_link( 'https://help.ahrefs.com/en/articles/4666920-how-do-i-connect-google-analytics-search-console-to-the-plugin', __( 'How do I connect the right Google Analytics & Search Console accounts?', 'ahrefs-seo' ) ); ?>
	</div>
</div>
<?php
