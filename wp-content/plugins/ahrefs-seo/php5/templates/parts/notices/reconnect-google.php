...
<div class="ahrefs-content-tip tip-reconnect-google tip-notice">
	<div class="caption">
	<?php
	esc_html_e( 'Please reconnect your Google account', 'ahrefs-seo' );
	?>
	</div>
	<div class="text">
		<?php
	...
	if ( current_user_can( Ahrefs_Seo::CAP_SETTINGS_ACCOUNTS_SAVE ) ) {
		?>
		<div class="buttons">
			<a id="open_google_settings_button" class="button button-primary content_tip_reconnect_google" href="<?php echo esc_attr( $url ); ?>">
																															<?php
