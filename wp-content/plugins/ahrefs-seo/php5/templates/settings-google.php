...
$disconnect_url = add_query_arg( [ 'disconnect-analytics' => wp_create_nonce( $locals['page_nonce'] ) ], 'settings' === $locals['disconnect_link'] ? Links::settings( Ahrefs_Seo_Screen_Settings::TAB_ANALYTICS ) : Links::wizard_step( 2 ) );
