    ...
    function __construct($mode = self::MODE_CBC)
    {
        switch ($mode) {
            ...
            case self::MODE_3CBC:
                ...
                $this->des = array(new \ahrefs\AhrefsSeo_Vendor\phpseclib\Crypt\DES(self::MODE_CBC), new \ahrefs\AhrefsSeo_Vendor\phpseclib\Crypt\DES(self::MODE_CBC), new \ahrefs\AhrefsSeo_Vendor\phpseclib\Crypt\DES(self::MODE_CBC));
