...
class StreamWrapper
{
     ...
     */
    public static function getResource(\ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\StreamInterface $stream)
    {
