 ...
 * @final
 */
class AppendStream implements \ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \ahrefs\AhrefsSeo_Vendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
