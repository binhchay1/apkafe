 ...
 * @final
 */
class FnStream implements \ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
