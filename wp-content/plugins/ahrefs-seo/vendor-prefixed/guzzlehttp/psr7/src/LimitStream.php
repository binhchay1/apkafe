 ...
 * @final
 */
class LimitStream implements \ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
