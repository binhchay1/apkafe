 ...
 */
class HipChatHandler extends \ahrefs\AhrefsSeo_Vendor\Monolog\Handler\SocketHandler
{
    /**
     * Use API version 1
     */
     ...
     */
    public function __construct($token, $room, $name = 'Monolog', $notify = \false, $level = \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $format = 'text', $host = 'api.hipchat.com', $version = self::API_V1)
    {
    ...
    protected function getAlertColor($level)
    {
        switch (\true) {
            ...
            case $level >= \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::INFO:
                return 'green';
            case $level == \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::DEBUG:
                return 'gray';
            default:
                return 'yellow';
        }
