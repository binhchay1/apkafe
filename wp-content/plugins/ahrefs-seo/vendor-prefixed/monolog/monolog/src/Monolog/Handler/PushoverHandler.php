 ...
 */
class PushoverHandler extends \ahrefs\AhrefsSeo_Vendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::CRITICAL, $emergencyLevel = \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
