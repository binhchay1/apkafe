 ...
 */
class SlackbotHandler extends \ahrefs\AhrefsSeo_Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
