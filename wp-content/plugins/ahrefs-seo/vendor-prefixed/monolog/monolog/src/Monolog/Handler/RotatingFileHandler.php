 ...
 */
class RotatingFileHandler extends \ahrefs\AhrefsSeo_Vendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \ahrefs\AhrefsSeo_Vendor\Monolog\Utils::canonicalizePath($filename);
