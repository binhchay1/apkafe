 ...
 */
abstract class AbstractHandler implements \ahrefs\AhrefsSeo_Vendor\Monolog\Handler\HandlerInterface, \ahrefs\AhrefsSeo_Vendor\Monolog\ResettableInterface
{
    protected $level = \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::DEBUG;
    ...
    {
        $this->level = \ahrefs\AhrefsSeo_Vendor\Monolog\Logger::toMonologLevel($level);
        return $this;
    }
    /**
