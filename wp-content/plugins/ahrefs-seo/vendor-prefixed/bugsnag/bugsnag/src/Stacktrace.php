...
class Stacktrace
{
     ...
     * @return static
     */
    public static function generate(\Bugsnag\Configuration $config)
    {
     ...
     * @return static
     */
    public static function fromFrame(\Bugsnag\Configuration $config, $file, $line)
    {
     ...
     * @return static
     */
    public static function fromBacktrace(\Bugsnag\Configuration $config, array $backtrace, $topFile, $topLine)
    {
        // @phpstan-ignore-next-line
        $stacktrace = new static($config);
     ...
     * @return void
     */
    public function __construct(\Bugsnag\Configuration $config)
    {
        $this->config = $config;
    }
    /**
