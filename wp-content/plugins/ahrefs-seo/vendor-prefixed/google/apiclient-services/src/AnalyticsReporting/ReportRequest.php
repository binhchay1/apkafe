...
class ReportRequest extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
    protected $collection_key = 'segments';
    protected $cohortGroupType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\CohortGroup::class;
    protected $cohortGroupDataType = '';
    protected $dateRangesType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\DateRange::class;
    protected $dateRangesDataType = 'array';
    protected $dimensionFilterClausesType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\DimensionFilterClause::class;
    protected $dimensionFilterClausesDataType = 'array';
    protected $dimensionsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\Dimension::class;
    ...
    protected $metricFilterClausesType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\MetricFilterClause::class;
    protected $metricFilterClausesDataType = 'array';
    protected $metricsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\Metric::class;
    protected $metricsDataType = 'array';
    protected $orderBysType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\OrderBy::class;
     ...
     */
    public $pageToken;
    protected $pivotsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\Pivot::class;
    protected $pivotsDataType = 'array';
    /**
     * @var string
     */
    public $samplingLevel;
    protected $segmentsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\Segment::class;
     ...
     * @param CohortGroup
     */
    public function setCohortGroup(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\CohortGroup $cohortGroup)
    {
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\ReportRequest::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsReporting_ReportRequest');
