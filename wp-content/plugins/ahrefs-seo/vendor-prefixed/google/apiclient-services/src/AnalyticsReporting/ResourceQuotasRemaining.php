...
class ResourceQuotasRemaining extends \ahrefs\AhrefsSeo_Vendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\ResourceQuotasRemaining::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsReporting_ResourceQuotasRemaining');
