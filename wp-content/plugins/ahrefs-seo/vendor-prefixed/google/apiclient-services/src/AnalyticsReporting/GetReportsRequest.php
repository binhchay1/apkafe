...
class GetReportsRequest extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
    protected $collection_key = 'reportRequests';
    protected $reportRequestsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\ReportRequest::class;
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\GetReportsRequest::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsReporting_GetReportsRequest');
