...
class MetricHeader extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
    protected $collection_key = 'pivotHeaders';
    protected $metricHeaderEntriesType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\MetricHeaderEntry::class;
    protected $metricHeaderEntriesDataType = 'array';
    protected $pivotHeadersType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\PivotHeader::class;
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\MetricHeader::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsReporting_MetricHeader');
