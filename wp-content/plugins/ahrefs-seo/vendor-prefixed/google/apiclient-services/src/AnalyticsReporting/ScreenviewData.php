...
class ScreenviewData extends \ahrefs\AhrefsSeo_Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\ScreenviewData::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsReporting_ScreenviewData');
