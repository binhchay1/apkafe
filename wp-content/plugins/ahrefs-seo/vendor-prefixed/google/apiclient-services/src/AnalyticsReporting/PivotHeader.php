...
class PivotHeader extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
    protected $collection_key = 'pivotHeaderEntries';
    protected $pivotHeaderEntriesType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\PivotHeaderEntry::class;
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\PivotHeader::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsReporting_PivotHeader');
