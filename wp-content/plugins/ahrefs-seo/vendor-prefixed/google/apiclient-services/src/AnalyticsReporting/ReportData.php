...
class ReportData extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
     ...
     */
    public $isDataGolden;
    protected $maximumsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\DateRangeValues::class;
    protected $maximumsDataType = 'array';
    protected $minimumsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\DateRangeValues::class;
    protected $minimumsDataType = 'array';
    /**
     * @var int
     */
    public $rowCount;
    protected $rowsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\ReportRow::class;
    ...
    protected $totalsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\DateRangeValues::class;
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\ReportData::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsReporting_ReportData');
