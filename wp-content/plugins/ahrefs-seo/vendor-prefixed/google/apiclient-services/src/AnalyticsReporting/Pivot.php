...
class Pivot extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\Pivot::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsReporting_Pivot');
