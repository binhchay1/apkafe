...
class OrFiltersForSegment extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
    protected $collection_key = 'segmentFilterClauses';
    protected $segmentFilterClausesType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\SegmentFilterClause::class;
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\OrFiltersForSegment::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsReporting_OrFiltersForSegment');
