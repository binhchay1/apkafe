...
class SegmentMetricFilter extends \ahrefs\AhrefsSeo_Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsReporting\SegmentMetricFilter::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsReporting_SegmentMetricFilter');
