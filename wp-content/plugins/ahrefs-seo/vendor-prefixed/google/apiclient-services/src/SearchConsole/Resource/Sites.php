...
use ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\SitesListResponse;
use ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\WmxSite;
/**
 ...
 *  </code>
 */
class Sites extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($siteUrl, $optParams = [])
    {
        $params = ['siteUrl' => $siteUrl];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\WmxSite::class);
    }
    /**
    ...
    public function listSites($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\SitesListResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\Resource\Sites::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_SearchConsole_Resource_Sites');
