 ...
 *  </code>
 */
class Searchanalytics extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function query($siteUrl, \ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\SearchAnalyticsQueryRequest $postBody, $optParams = [])
    {
        $params = ['siteUrl' => $siteUrl, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('query', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\SearchAnalyticsQueryResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\Resource\Searchanalytics::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_SearchConsole_Resource_Searchanalytics');
