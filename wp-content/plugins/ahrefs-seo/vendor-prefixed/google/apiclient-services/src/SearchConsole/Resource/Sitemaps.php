...
use ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\SitemapsListResponse;
use ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\WmxSitemap;
/**
 ...
 *  </code>
 */
class Sitemaps extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($siteUrl, $feedpath, $optParams = [])
    {
        $params = ['siteUrl' => $siteUrl, 'feedpath' => $feedpath];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\WmxSitemap::class);
    }
    /**
    ...
    public function listSitemaps($siteUrl, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\SitemapsListResponse::class);
    }
    /**
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\SearchConsole\Resource\Sitemaps::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_SearchConsole_Resource_Sitemaps');
