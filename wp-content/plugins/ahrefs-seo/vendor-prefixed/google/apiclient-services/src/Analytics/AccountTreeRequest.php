...
class AccountTreeRequest extends \ahrefs\AhrefsSeo_Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\AccountTreeRequest::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_AccountTreeRequest');
