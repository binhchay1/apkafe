...
class Profile extends \ahrefs\AhrefsSeo_Vendor\Google\Model
{
    /**
     * @var string
     */
    ...
    protected $childLinkType = \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\ProfileChildLink::class;
     ...
     */
    public $name;
    protected $parentLinkType = \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\ProfileParentLink::class;
    protected $parentLinkDataType = '';
    protected $permissionsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\ProfilePermissions::class;
     ...
     */
    public function setChildLink(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\ProfileChildLink $childLink)
    {
     ...
     */
    public function setParentLink(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\ProfileParentLink $parentLink)
    {
     ...
     */
    public function setPermissions(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\ProfilePermissions $permissions)
    {
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Profile::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Profile');
