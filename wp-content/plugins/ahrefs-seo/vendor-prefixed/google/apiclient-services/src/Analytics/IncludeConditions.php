...
class IncludeConditions extends \ahrefs\AhrefsSeo_Vendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\IncludeConditions::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_IncludeConditions');
