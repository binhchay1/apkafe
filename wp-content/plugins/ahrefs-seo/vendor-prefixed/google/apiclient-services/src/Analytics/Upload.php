...
class Upload extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Upload::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Upload');
