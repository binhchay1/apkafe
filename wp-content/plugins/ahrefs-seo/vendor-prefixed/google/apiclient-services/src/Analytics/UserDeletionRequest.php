...
class UserDeletionRequest extends \ahrefs\AhrefsSeo_Vendor\Google\Model
{
    /**
     * @var string
     */
    ...
    protected $idType = \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\UserDeletionRequestId::class;
     ...
     */
    public function setId(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\UserDeletionRequestId $id)
    {
        $this->id = $id;
    }
    /**
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\UserDeletionRequest::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_UserDeletionRequest');
