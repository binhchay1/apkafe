...
class GoogleAnalyticsAdminV1alphaAudience extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
     ...
     */
    public $displayName;
    protected $eventTriggerType = \ahrefs\AhrefsSeo_Vendor\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaAudienceEventTrigger::class;
    protected $eventTriggerDataType = '';
    /**
     * @var string
     */
    public $exclusionDurationMode;
    protected $filterClausesType = \ahrefs\AhrefsSeo_Vendor\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaAudienceFilterClause::class;
     ...
     */
    public function setEventTrigger(\ahrefs\AhrefsSeo_Vendor\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaAudienceEventTrigger $eventTrigger)
    {
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaAudience::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaAudience');
