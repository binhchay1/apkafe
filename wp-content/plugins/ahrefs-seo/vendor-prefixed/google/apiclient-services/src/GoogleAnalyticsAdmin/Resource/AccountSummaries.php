...
use ahrefs\AhrefsSeo_Vendor\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1betaListAccountSummariesResponse;
/**
...
class AccountSummaries extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    ...
    public function listAccountSummaries($optParams = [])
    {
        ...
        return $this->call('list', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1betaListAccountSummariesResponse::class);
    }
}
