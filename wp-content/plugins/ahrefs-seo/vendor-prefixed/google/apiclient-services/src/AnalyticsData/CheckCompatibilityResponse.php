...
class CheckCompatibilityResponse extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
    protected $collection_key = 'metricCompatibilities';
    protected $dimensionCompatibilitiesType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\DimensionCompatibility::class;
    protected $dimensionCompatibilitiesDataType = 'array';
    protected $metricCompatibilitiesType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\MetricCompatibility::class;
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\CheckCompatibilityResponse::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsData_CheckCompatibilityResponse');
