...
class SchemaRestrictionResponse extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
    protected $collection_key = 'activeMetricRestrictions';
    protected $activeMetricRestrictionsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\ActiveMetricRestriction::class;
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\SchemaRestrictionResponse::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsData_SchemaRestrictionResponse');
