...
class PivotOrderBy extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
     ...
     */
    public $metricName;
    protected $pivotSelectionsType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\PivotSelection::class;
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\PivotOrderBy::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsData_PivotOrderBy');
