...
class ResponseMetaData extends \ahrefs\AhrefsSeo_Vendor\Google\Model
{
    /**
     * @var string
     */
     ...
     */
    public $emptyReason;
    protected $schemaRestrictionResponseType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\SchemaRestrictionResponse::class;
     ...
     */
    public function setSchemaRestrictionResponse(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\SchemaRestrictionResponse $schemaRestrictionResponse)
    {
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\ResponseMetaData::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsData_ResponseMetaData');
