...
class MinuteRange extends \ahrefs\AhrefsSeo_Vendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\MinuteRange::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsData_MinuteRange');
