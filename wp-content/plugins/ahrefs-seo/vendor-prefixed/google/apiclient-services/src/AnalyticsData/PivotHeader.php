...
class PivotHeader extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
    ...
    protected $pivotDimensionHeadersType = \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\PivotDimensionHeader::class;
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\PivotHeader::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsData_PivotHeader');
