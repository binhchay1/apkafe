...
class RunReportRequest extends \ahrefs\AhrefsSeo_Vendor\Google\Collection
{
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunReportRequest::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsData_RunReportRequest');
