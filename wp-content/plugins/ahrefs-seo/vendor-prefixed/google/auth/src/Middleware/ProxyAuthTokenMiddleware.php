 ...
 */
namespace ahrefs\AhrefsSeo_Vendor\Google\Auth\Middleware;

use ahrefs\AhrefsSeo_Vendor\Google\Auth\FetchAuthTokenInterface;
...
class ProxyAuthTokenMiddleware
{
     ...
     */
    public function __construct(\ahrefs\AhrefsSeo_Vendor\Google\Auth\FetchAuthTokenInterface $fetcher, callable $httpHandler = null, callable $tokenCallback = null)
    {
    ...
    {
        return function (\ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\RequestInterface $request, array $options) use($handler) {
            ...
            if ($quotaProject = $this->getQuotaProject()) {
                $request = $request->withHeader(\ahrefs\AhrefsSeo_Vendor\Google\Auth\GetQuotaProjectInterface::X_GOOG_USER_PROJECT_HEADER, $quotaProject);
            }
            return $handler($request, $options);
        };
    }
