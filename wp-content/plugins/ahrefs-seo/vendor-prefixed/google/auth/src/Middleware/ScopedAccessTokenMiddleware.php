...
use ahrefs\AhrefsSeo_Vendor\Google\Auth\CacheTrait;
...
class ScopedAccessTokenMiddleware
{
     ...
     */
    public function __construct(callable $tokenFunc, $scopes, array $cacheConfig = null, \ahrefs\AhrefsSeo_Vendor\Psr\Cache\CacheItemPoolInterface $cache = null)
    {
