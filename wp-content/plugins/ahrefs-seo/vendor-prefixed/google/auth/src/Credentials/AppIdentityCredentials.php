 ...
 */
use ahrefs\AhrefsSeo_Vendor\google\appengine\api\app_identity\AppIdentityService;
 ...
 * ```
 */
class AppIdentityCredentials extends \ahrefs\AhrefsSeo_Vendor\Google\Auth\CredentialsLoader implements \ahrefs\AhrefsSeo_Vendor\Google\Auth\SignBlobInterface, \ahrefs\AhrefsSeo_Vendor\Google\Auth\ProjectIdProviderInterface
{
    /**
    ...
    public function fetchAuthToken(callable $httpHandler = null)
    {
        ...
        $token = \ahrefs\AhrefsSeo_Vendor\google\appengine\api\app_identity\AppIdentityService::getAccessToken($scope);
    ...
    {
        $this->checkAppEngineContext();
        return \base64_encode(\ahrefs\AhrefsSeo_Vendor\google\appengine\api\app_identity\AppIdentityService::signForApp($stringToSign)['signature']);
    }
    /**
    ...
    public function getProjectId(callable $httpHander = null)
    {
        ...
        return \ahrefs\AhrefsSeo_Vendor\google\appengine\api\app_identity\AppIdentityService::getApplicationId();
    }
    /**
    ...
    public function getClientName(callable $httpHandler = null)
    {
        $this->checkAppEngineContext();
        if (!$this->clientName) {
            $this->clientName = \ahrefs\AhrefsSeo_Vendor\google\appengine\api\app_identity\AppIdentityService::getServiceAccountName();
        }
    ...
    {
        if (!self::onAppEngine() || !\class_exists('ahrefs\\AhrefsSeo_Vendor\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
