 ...
 */
class UserRefreshCredentials extends \ahrefs\AhrefsSeo_Vendor\Google\Auth\CredentialsLoader implements \ahrefs\AhrefsSeo_Vendor\Google\Auth\GetQuotaProjectInterface
{
    /**
    ...
    public function __construct($scope, $jsonKey)
    {
        ...
        $this->auth = new \ahrefs\AhrefsSeo_Vendor\Google\Auth\OAuth2(['clientId' => $jsonKey['client_id'], 'clientSecret' => $jsonKey['client_secret'], 'refresh_token' => $jsonKey['refresh_token'], 'scope' => $scope, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI]);
