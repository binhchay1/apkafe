...
class Resource
{
    ...
    public function call($name, $arguments, $expectedClass = null)
    {
        ...
        $request = new \ahrefs\AhrefsSeo_Vendor\GuzzleHttp\Psr7\Request($method['httpMethod'], $url, $postBody ? ['content-type' => 'application/json'] : [], $postBody ? \json_encode($postBody) : '');
        // support uploads
