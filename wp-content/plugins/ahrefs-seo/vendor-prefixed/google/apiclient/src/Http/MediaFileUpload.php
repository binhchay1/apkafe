...
class MediaFileUpload
{
     ...
     */
    public function __construct(\ahrefs\AhrefsSeo_Vendor\Google\Client $client, \ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\RequestInterface $request, $mimeType, $data, $resumable = \false, $chunkSize = 0)
    {
        $this->client = $client;
