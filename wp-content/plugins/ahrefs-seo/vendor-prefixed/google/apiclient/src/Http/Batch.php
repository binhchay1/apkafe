...
EOF;
    ...
    public function parseResponse(\ahrefs\AhrefsSeo_Vendor\Psr\Http\Message\ResponseInterface $response, $classes = [])
    {
        ...
        if (!empty($body)) {
            ...
            foreach ($parts as $i => $part) {
                ...
                if (!empty($part)) {
                    ...
                    $response = new \ahrefs\AhrefsSeo_Vendor\GuzzleHttp\Psr7\Response((int) $status, $partHeaders, \ahrefs\AhrefsSeo_Vendor\GuzzleHttp\Psr7\Utils::streamFor($partBody));
                    // Need content id.
