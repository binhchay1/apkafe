...
class custom_walker_nav_menu extends Walker_Nav_Menu
{
	...
	{
		$output .= '<ul class="nav_submenu"><li class="nav_submenu-item"><div class="menu_list"><div class="menu_body"><ul><li>';
	}

	function end_lvl(&$output, $depth = 0, $args = array())
	{
		$output .= '</ul><div class="clear"></div></div></div></li></ul>';
	}
	...
	function start_el(&$output, $item, $depth = 0, $args = array(),  $current_object_id = 0)
	{
		...
		$depth_classes = array(
			($depth == 0 ? 'main-menu-item item searching-hide' : 'sub-menu-item nav_submenu-item'),
		...
		if(strpos($class_names, 'parent') > 0) {
			$class_names .= ' many';
		}
