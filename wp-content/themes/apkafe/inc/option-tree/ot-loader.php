    ...
    private function load_languages() {
      ...
      if ( OT_PLUGIN_MODE ) {
        ...
        if ( apply_filters( 'ot_child_theme_mode', false ) == true ) {
          ...
          $_explode = @explode( get_template(), str_replace( '\\', '/', dirname( __FILE__ ) ) );
          $path = ltrim( end( $_explode ), '/' );
    ...
    private function constants() {
      ...
      if ( false == OT_THEME_MODE && false == OT_CHILD_THEME_MODE ) {
        ...
        if ( true == OT_CHILD_THEME_MODE ) {
          ...
          $__explode = @explode( get_template(), str_replace( '\\', '/', dirname( __FILE__ ) ) );
          $path = ltrim( end( $__explode ), '/' );
