    ...
    if (in_array('background-image', $ot_recognized_background_fields)) {
      ...
      if (isset($field_value['background-image']) && $field_value['background-image'] !== '') {
        ...
        if (preg_match('/\.(?:jpe?g|png|gif|ico)$/i', $field_value['background-image']))
          echo '<div class="option-tree-ui-image-wrap"><img src="' . esc_url($field_value['background-image']) . '" alt="bg" /></div>';
...
if (!function_exists('ot_type_category_checkbox')) {
  ...
  function ot_type_category_checkbox($args = array())
  {
    ...
    /* get category array */
    $categories_post = get_categories(apply_filters('ot_type_category_checkbox_query', array('hide_empty' => true), $field_id));
    $args = array(
      'taxonomy'     => 'product_cat',
      'orderby'      => 'name',
      'hide_empty'   => true
    );
    $categories_product = get_categories($args);
    $categories = array_merge($categories_post, $categories_product);
  ...
  function ot_type_upload($args = array())
  {
    ...
    if ($field_value) {
      ...
      if (preg_match('/\.(?:jpe?g|png|gif|ico)$/i', $field_value))
        echo '<div class="option-tree-ui-image-wrap"><img src="' . esc_url($field_value) . '" alt="img" /></div>';
