...
$search = $_POST['s'];
$current_page_news = (get_query_var('paged')) ? absint(get_query_var('paged')) : 1;
$args = array(
    's' => $search,
    'paged' => $paged,
    'posts_per_page' => 15,
...
<div class="container">
    <div class="content-pad-4x">
        ...
        <div id="content">
            <div class="widget">
                <h2 class="widget_head">Search result</h2>
            </div>
                ...
                <div class="main_list_item">
                    <?php foreach ($get_post->posts as $post) { ?>
                        <a class="side_list_item" href="<?php echo get_permalink($post->ID) ?>">
                            ...
                            <?php
                            $rating = get_post_meta($post->ID, 'rating', false);
                            $developer = get_post_meta($post->ID, 'developer', false);
                            ?>
            ...
            <?php } else { ?>
                <div class="col-md-6 align-self-center icon-404">
